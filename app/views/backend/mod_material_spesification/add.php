...
<div class="col-sm-12">
    <div class="card">
        <div class="card-body">
            ...
            <?php $attributes = array('class'=>'form-horizontal','role'=>'form','autocomplete'=>'off','name'=>'form'); echo form_open_multipart('material_spesification/tambah_material_spesification',$attributes); ?>
                ...
                <div class="form-group row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="b" id="pin" placeholder="Masukan pin">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputEmail1">Tgl</label>
                            <input type="date" class="form-control" name="c" id="tgl" placeholder="Masukan tgl">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputEmail1">Nama Item</label>
                            <input type="text" class="form-control" name="d" id="nama_item" placeholder="Masukan nama item">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputEmail1">Kategori</label>
                            <input type="text" class="form-control" name="e" id="kategori" placeholder="Masukan kategori">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputEmail1">Tipe</label>
                            <input type="text" class="form-control" name="f" id="tipe" placeholder="Masukan tipe">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputEmail1">Warna</label>
                            <input type="text" class="form-control" name="g" id="warna" placeholder="Masukan warna">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputEmail1">Harga</label>
                            <input type="text" class="form-control" name="h" id="harga" placeholder="Masukan harga">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputEmail1">Moq</label>
                            <input type="text" class="form-control" name="i" id="moq" placeholder="Masukan moq">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputEmail1">Packaging</label>
                            <input type="text" class="form-control" name="j" id="packaging" placeholder="Masukan packaging">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputEmail1">Tr Reference</label>
                            <input type="text" class="form-control" name="k" id="tr_reference" placeholder="Masukan TR Reference">
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Tipe</label>
                            <input type="text" class="form-control" name="l" id="app_tipe_mesin">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Detil</label>
                            <input type="text" class="form-control" name="m" id="app_detil_mesin">
                        </div>
                    </div>
                </div>
                <hr>
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <textarea class="form-control" name="n"></textarea>
                        </div>
                    </div>
                </div>
                <hr>
